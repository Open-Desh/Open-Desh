      ...
      return [
        {
          ...
          citizenEntitlement: "Zero-overflow door pickup with real-time route tracking on Open Nation.",
    ...
    if (normalizedRole === "pm" || normalizedRole.includes("prime") || normalizedRole.includes("cabinet") || normalizedRole === "mp" || normalizedSub.includes("national")) {
      return [
        ...
        },
        {
          ...
          citizenEntitlement: "Public domain progress dashboard with satellite geo-tracking on Open Nation.",
